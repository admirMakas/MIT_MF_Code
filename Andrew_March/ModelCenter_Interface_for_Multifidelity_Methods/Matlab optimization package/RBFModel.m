% RBFModelm: Builds a fully linear radial basis function model of the
...
%       fully linear model:
[krig,failed]=AddPoints(xk,fxk(2)-fxk(1),D,Y2,krig,index,theta2,theta4*deltamax,pmax,optTheta);
if(failed)
    [krig,failed]=AddPoints(xk,fxk(2)-fxk(1),D,Y2,krig,index,theta2,theta4*deltamax,pmax,optTheta);
end
