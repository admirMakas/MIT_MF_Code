...
OPTIMIZATION OF A MULTIFIDELITY OBJECTIVE -- SUBJECT TO A MULTIFIDELITY
CONSTRAINT and other easy constraints.
...
AppEvery.m: The main file to optimize an airfoil (or other function)
    with two-fidelity levels. Both the objective function and a constraint
    are optimized using multifidelity methods. This algorithm is the full
    version of Algorithm 2 in the attached paper.
