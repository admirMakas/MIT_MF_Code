! $Id: diag49_mod.f,v 1.1.1.1 2009/06/09 21:51:53 daven Exp $
      MODULE DIAG49_MOD
!
!******************************************************************************
...
!  (19) LONRES           (TYPE (XPLEX)  ) : Used for binary punch file write
!  (20) LATRES           (TYPE (XPLEX)  ) : Used for binary punch file write
...
#     include "CMN_GCTM"        ! XTRA2
      ...
      INTEGER                  :: N,   R,     H,    W, X, Y
      TYPE (XPLEX)                   :: TAU, TMP,   SCALE400nm
      TYPE (XPLEX)                   :: Q( ND49_NI, ND49_NJ, ND49_NL )
