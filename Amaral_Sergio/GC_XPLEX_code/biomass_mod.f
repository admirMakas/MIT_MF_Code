! $Id: biomass_mod.f,v 1.2 2009/11/18 07:09:33 daven Exp $
      MODULE BIOMASS_MOD
!
!******************************************************************************
...
!  Module Variables:
!  ============================================================================
!  (1 ) BIOMASS      (TYPE (XPLEX) )    : Biomass emissions [molec/cm3/s]
!  (2 ) BIOMASS_SAVE (TYPE (XPLEX) )    : Internal array for biomass emissions 
...
!
      ...
      TYPE (XPLEX),  ALLOCATABLE :: BIOMASS(:,:,:)
