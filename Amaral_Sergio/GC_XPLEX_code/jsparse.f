! $Id: jsparse.f,v 1.1.1.1 2009/06/09 21:51:53 daven Exp $
      SUBROUTINE JSPARSE
!
!******************************************************************************
...
C
      ...
      TYPE (XPLEX) RFRAC,ALFRAC,DIFF,TNUMGNA,TNUMGN
      TYPE (XPLEX) TNUMLS,SUMGN,TSUMGNA,TNUMLSA
...
C
 ...
 320   FORMAT('GAINS/LOSSES FOR ',A14,' = ',2(2F8.3),I5)     
 370   FORMAT('TOTAL GAINS - LOSSES            = ',3(2F8.3)) 
 375   FORMAT(/'# KINETIC REACTIONS: ',I5,' PHOTORATES: ',I5,
     1        ' TOTAL: ',I5) 
 240   FORMAT('SPEC           NUMGT  NUMG  NUMLT NUML   NGT-NLT-', 
     1        'NG+NL FRACGN NUMGFT') 
 250   FORMAT(A14,4(2X,I4),7X,I4,3X,2F8.3,I5)
