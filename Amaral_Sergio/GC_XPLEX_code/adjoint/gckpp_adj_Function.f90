!$Id: gckpp_adj_Function.f90,v 1.3 2009/08/17 03:59:52 daven Exp $
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
...
! Need to declare this THREADPRIVATE for OMP parallelization (dkh, 07/28/09) 
!$OMP THREADPRIVATE( A )
...
! Vdot - Time derivative of variable species concentrations
  TYPE (XPLEX) :: Vdot(NVAR)
  integer :: i
!  do i=1,size(V)
!     if (isnan(V(i))) then
!        print*,'V(i) is nan in func',V(i),i
!     endif
!  enddo
!  do i=1,size(F)
!     if (isnan(F(i))) then
!        print*,'F(i) is nan in func',F(i),i
!     endif
!  enddo
!  do i=1,size(RCT)
!     if (isnan(RCT(i))) then
!        print*,'RCT(i) is nan in func',RCT(i),i
!     endif
!  enddo
!  do i=1,size(Vdot)
!     if (isnan(Vdot(i))) then
!        print*,'Vdot(i) is nan in func',Vdot(i),i
!     endif
!  enddo
!  do i=1,size(A)
!     if (isnan(A(i))) then
!        print*,'A(i) is nan in func',A(i),i
!     endif
!  enddo
