...
!      TYPE (XPLEX),  PARAMETER   :: EPSILON = 1d-32
!
!      ! Scalars
!      INTEGER              :: NSOL 
!
...
!      TYPE (XPLEX),  ALLOCATABLE :: SO2s(:,:,:)
      ...
      ! adjoint variables
      TYPE (XPLEX),  ALLOCATABLE :: H2O2s_ADJ(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SO2s_ADJ(:,:,:)

      !>>>            
      ! Now include adjoint of F (dkh, 10/03/08) 
      TYPE (XPLEX),  ALLOCATABLE :: F_ADJ(:,:,:)
      !<<<
...
!
!      ! Parameters
!      TYPE (XPLEX), PARAMETER  :: A = -2663.5d0
!      TYPE (XPLEX), PARAMETER  :: B =  12.537d0
!
!      !=================================================================
!      ! E_ICE begins here!
!      !=================================================================
...
!      TYPE (XPLEX), PARAMETER   :: R = 8.32d-2
!
!      ! INV_T0 = 1/298 K
!      TYPE (XPLEX), PARAMETER   :: INV_T0 = 1d0 / 298d0
!
!      !=================================================================
...
!      TYPE (XPLEX), PARAMETER    :: CONV_H2O2 = 8.27042925126d-1
!
...
!      TYPE (XPLEX), PARAMETER    :: CONV_NH3  = 5.69209978831d-1
!
!      !=================================================================
...
!      TYPE (XPLEX), PARAMETER    :: K_WASH = 1d0
!
!      !=================================================================
!      ! WASHOUT begins here!
!      !
...
#     include "CMN_DIAG"  ! Diagnostic arrays and switches 
      ...
      TYPE (XPLEX)              :: WETLOSS_ADJ

      ! DSTT is the accumulator array of rained-out 
      ! soluble tracer for a given (I,J) column
      TYPE (XPLEX)              :: DSTT_ADJ(NSOL,LLPAR,IIPAR,JJPAR)

      TYPE (XPLEX)              :: F_SAVE(IIPAR,JJPAR,LLPAR)
...
#     include "CMN_SIZE"  ! Size parameters
      ...
      !TYPE (XPLEX) :: H2O2s(10,10,10)
      !TYPE (XPLEX) :: SO2s(10,10,10)
      !TYPE (XPLEX) :: QQ(10,10,10) 
      !TYPE (XPLEX) :: PDOWN(10,10,10)
      !TYPE (XPLEX) :: STT(10,10,10,10)
      !INTEGER :: IDTSO2, LLPAR, IDTSO4
      !TYPE (XPLEX)              :: DSTT(10,10)
      ...
      TYPE (XPLEX)              :: F,     FTOP,   F_PRIME,   WASHFRAC
      TYPE (XPLEX)              :: LOST,  GAINED, MASS_WASH, MASS_NOWASH
      TYPE (XPLEX)              :: ALPHA, ALPHA2, WETLOSS,   L_PLUS_W
      TYPE (XPLEX)              :: XDSTT, TMP

      ! DSTT is the accumulator array of rained-out 
      ! soluble tracer for a given (I,J) column
      TYPE (XPLEX)              :: DSTT(NSOLMAX,LLPAR)

      ! Checkpointing vectors. Label them MCHK because we store
      ! them in Memory. 
      TYPE (XPLEX) :: F_MCHK(LLPAR)
      TYPE (XPLEX) :: SO2_MCHK(LLPAR) 
      TYPE (XPLEX) :: SO4_MCHK(LLPAR) 
      TYPE (XPLEX) :: H2O2s_MCHK(LLPAR)
      TYPE (XPLEX) :: SO2s_MCHK(LLPAR)
      TYPE (XPLEX) :: ALPHA_MCHK(LLPAR)
      TYPE (XPLEX) :: RAINFRAC_MCHK(LLPAR)
      TYPE (XPLEX) :: WASHFRAC_MCHK(LLPAR)
      TYPE (XPLEX) :: WASHFRAC_0(LLPAR)
      TYPE (XPLEX) :: RAINFRAC_0(LLPAR)
...
C==============================================
      ...
      !TYPE (XPLEX) addstt(10,10)
      TYPE (XPLEX) ADDSTT(1,LLPAR)
      TYPE (XPLEX) adgained
      !TYPE (XPLEX) ADJ_H2O2s(10,10,10)
      TYPE (XPLEX) adrainfrac
      !TYPE (XPLEX) ADJ_SO2s(10,10,10)
      !TYPE (XPLEX) adstt(10,10,10,10)
      TYPE (XPLEX) adwashfrac
      TYPE (XPLEX) adwetloss
...
!                     N  = IDWETD(NN)
                     ...
                     WASHFRAC_0(L) = 
     &                WASHFRAC_AEROSOL( DT,F,xplx(1d0),QDOWN,T(I,J,L))
...
C==============================================
      ...
      !TYPE (XPLEX) adh2o2s(10,10,10)
      TYPE (XPLEX) adrainfrac
      ! make this a module var
      !TYPE (XPLEX) adso2s(10,10,10)
...
C define local variables
C==============================================
      TYPE (XPLEX) adso2loss
      ! EPSILON is actually a module variable
      !TYPE (XPLEX) epsilon
      !TYPE (XPLEX) h2o2sh(10,10,10)
      TYPE (XPLEX) H2O2sh
      !integer ip1
      !integer ip2
      !integer ip3
      TYPE (XPLEX) rainfrach
      TYPE (XPLEX) so2loss
      !TYPE (XPLEX) so2sh(10,10,10)
      TYPE (XPLEX) SO2sh
