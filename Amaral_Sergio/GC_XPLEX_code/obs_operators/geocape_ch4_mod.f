...
! 
      ...
      TYPE (XPLEX)               :: AVGKERNEL(    LLGEOCAPE, LLGEOCAPE )
      TYPE (XPLEX)               :: OBSERROR(     LLGEOCAPE, LLGEOCAPE )
      TYPE (XPLEX)               :: OBSERROR_INV( LLGEOCAPE, LLGEOCAPE )
      TYPE (XPLEX)               :: TOTERROR_INV( LLGEOCAPE, LLGEOCAPE )
      TYPE (XPLEX)                     :: PRESSURE( LLGEOCAPE )
      TYPE (XPLEX)                     :: PRESSURE_EDGE( LLGEOCAPE )
      TYPE (XPLEX)                     :: RANDNUM( MAXGEOCAPE )
...
#     include      "CMN_SIZE"      ! Size params
      ...
      TYPE (XPLEX)                   :: CH4_PRIOR(IIPAR,JJPAR,LLGEOCAPE)
      TYPE (XPLEX)                 :: DUMMY_PRIOR(IIPAR,JJPAR,LLGEOCAPE)
      ...
      TYPE (XPLEX)                      :: GC_CH4_onGEOCAPE(LLGEOCAPE)
      TYPE (XPLEX)                     :: GC_CH4_onGEOCAPE_OB(LLGEOCAPE)
      TYPE (XPLEX)                      :: GRIDMAP(LLPAR,LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_HAT(LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_HAT_OB(LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_HAT_ADJ(LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_HAT_werr(LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_HAT_werr_ADJ(LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_PERT(LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_PERT_OB(LLGEOCAPE)
      TYPE (XPLEX)                      :: CH4_PERT_ADJ(LLGEOCAPE)
      ...
      TYPE (XPLEX)                      :: DIFF(LLGEOCAPE)
      TYPE (XPLEX)                      :: FORCE(LLGEOCAPE)
      TYPE (XPLEX)                      :: DIFF_ADJ(LLGEOCAPE)
      TYPE (XPLEX)                      :: thisforce(LLPAR)
      TYPE (XPLEX)                   :: GC_CH4_onGEOCAPE_ADJ(LLGEOCAPE)
      TYPE (XPLEX)                      :: GC_CH4_NATIVE_ADJ(LLPAR)
      TYPE (XPLEX)                      :: NEW_COST(MAXGEOCAPE)
      TYPE (XPLEX)                      :: OLD_COST
...
!  (2 ) SCIA_PEDGE (TYPE (XPLEX)) : LLGEOCAPE pressure edges of GEOCAPE column
!  (3 ) nlev       (TYPE (XPLEX)) : Number of GEOCAPE pressure levels to use
!     
!  Arguments as Output:
!  ============================================================================
!  (1 ) M          (TYPE (XPLEX)) : Interpolation matrix that maps GEOS-Chem to GEOCAPE grid
!     
!  NOTES:
...
#     include      "CMN_SIZE"      ! Size params
      ...
      ! Arguments
      TYPE (XPLEX)             :: GC_PEDGE(LLPAR)
      TYPE (XPLEX)             :: GEOCAPE_PEDGE(LLGEOCAPE)
      INTEGER            :: nlev
 
      ! Return value 
      TYPE (XPLEX)             :: M(LLPAR,LLGEOCAPE)

      ! Local variables 
      INTEGER  :: LGC, LTM, LS, LG, LN, LIND
      TYPE (XPLEX)   :: DIFF, DELTA_SURFP
      TYPE (XPLEX)   :: GUP, GLO, NUP, NLO
      TYPE (XPLEX)   :: column_total(LLGEOCAPE)
