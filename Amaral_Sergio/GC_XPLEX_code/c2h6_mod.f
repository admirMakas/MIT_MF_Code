! $Id: c2h6_mod.f,v 1.1.1.1 2009/06/09 21:51:53 daven Exp $
      MODULE C2H6_MOD
!
!******************************************************************************
...
!
      ...
      TYPE (XPLEX), ALLOCATABLE :: NGASC2H6(:,:)

      ! FMOL_C2H6: molecular weight of C2H6 [kg/mole]
      TYPE (XPLEX), PARAMETER   :: FMOL_C2H6 = xplex(30d-3,0d0)

      ! XNUMOL_C2H6  ratio of [molec C2H6/kg C2H6]
      TYPE (XPLEX),PARAMETER::XNUMOL_C2H6=xplex(6.022d+23/FMOL_C2H6%r,
     &                                          0d0)
...
!        TRANSFER_2D from "transfer_mod.f" to cast from TYPE (XPLEX) to COMPLEX*16.
...
#     include "CMN_DIAG"     ! Diagnostic arrays & switches
      ...
      TYPE (XPLEX)                 :: AREA_CM2,    XTAU  
      TYPE (XPLEX)                 :: E_C2H6_BB,   E_C2H6_BF
      TYPE (XPLEX)                 :: E_C2H6_NGAS, DTSRCE
