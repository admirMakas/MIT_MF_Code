! $Id: optdepth_mod.f,v 1.1.1.1 2009/06/09 21:51:50 daven Exp $
      MODULE OPTDEPTH_MOD
!
!******************************************************************************
...
!  (2 ) CLDF   (TYPE (XPLEX) ) : GEOS-3/GEOS-4 3/D cloud fraction [unitless]
!  (3 ) OPTDEP (TYPE (XPLEX) ) : GEOS-3/GEOS-4 grid box optical depths [unitless]
!
!  Arguments as output:
!  ===========================================================================
!  (4 ) OPTD   (TYPE (XPLEX) ) : DAO optical depth at grid box (I,J,L) [unitless]
!
!  NOTES:
...
#     include "CMN_DIAG"   ! ND21
      ...
      TYPE (XPLEX),  INTENT(IN)  :: OPTDEP(LLPAR,IIPAR,JJPAR)  
      TYPE (XPLEX),  INTENT(OUT) :: OPTD  (LLPAR,IIPAR,JJPAR)  
