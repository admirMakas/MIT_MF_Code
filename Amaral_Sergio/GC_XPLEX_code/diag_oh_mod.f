...
!  Module Variables:
!  ============================================================================
!  (1 ) AIR_MASS (TYPE (XPLEX)) : Array used to sum mean air mass [molec/cm3]
!  (2 ) OH_MASS  (TYPE (XPLEX)) : Array used to sum mean OH mass  [molec/cm3]
!
!  Module Routines:
!  ============================================================================
...
! 
      ...
      ! Arrays 
      TYPE (XPLEX), ALLOCATABLE :: OH_MASS(:,:,:)
      TYPE (XPLEX), ALLOCATABLE :: AIR_MASS(:,:,:)
      TYPE (XPLEX), ALLOCATABLE :: OH_LOSS(:,:,:)
...
#     include "comode.h"   ! NPVERT, NLAT, NLONG
      ...
      INTEGER       :: I,     J,       L,       JLOOP
      TYPE (XPLEX)        :: XLOSS, XOHMASS, XAIRMASS
...
!$OMP+SCHEDULE( DYNAMIC )
      ...
      DO I = 1, NLONG
         ...
         IF ( JLOOP > 0 ) THEN
            ...
            !print*,'CSPEC(JLOOP,IDOH)',CSPEC(JLOOP,IDOH)
...
!  (4  ) XOHMASS  (TYPE (XPLEX) ) : OH mass term from "global_ch4_mod.f"
!  (5  ) XAIRMASS (TYPE (XPLEX) ) : air mass term from "global_ch4_mod.f"
!
!  NOTES:
!******************************************************************************
!
      ...
      TYPE (XPLEX),  INTENT(IN) :: XOHMASS, XAIRMASS, XLOSS
...
!
      ! Local variables 
      TYPE (XPLEX) :: SUM_OHMASS, SUM_MASS, OHCONC
