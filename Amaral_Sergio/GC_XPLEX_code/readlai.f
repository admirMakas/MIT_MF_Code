! $Id: readlai.f,v 1.1.1.1 2009/06/09 21:51:52 daven Exp $
...
#     include "CMN_VEL"    ! XLAI, XLAI2
     ...
     &                                       '09','10','11','12'/)
      ...
      !REAL*8 :: D_XLAI(IGLOB,JGLOB,NTYPE),D_XLAI2(IGLOB,JGLOB,NTYPE)
 ...
 10   READ( IU_FILE, '(3i3,20f5.1)', END=20 ) 
     &     I, J, INDEX, ( D_XLAI(I,J,K), K=1,INDEX )
      !XLAI(:,:,:) = dcmplx(D_XLAI(:,:,:))
      GOTO 10
      !XLAI(:,:,:) = dcmplx(D_XLAI(:,:,:))
      ! Close file
 ...
 30   READ( IU_FILE, '(3i3,20f5.1)', END=40 )
     &     I, J, INDEX, ( D_XLAI2(I,J,K), K=1,INDEX )
      GOTO 30
      XLAI2(:,:,:) = (D_XLAI2(:,:,:))
      ! Close file
 40   CLOSE( IU_FILE )
      XLAI2(:,:,:) = (D_XLAI2(:,:,:))
      XLAI(:,:,:) = (D_XLAI(:,:,:))
      !print*,'XLAI',dble(XLAI)
      !print*,'XLAI2',dble(XLAI2) 
