! $Id: diag03_mod.f,v 1.1.1.1 2009/06/09 21:51:52 daven Exp $
      MODULE DIAG03_MOD
!
!******************************************************************************
...
!  Module Variables:
!  ============================================================================
!  (1 ) AD03         (TYPE (XPLEX)) : Array for Hg emissions & ocean masses 
!  (2 ) AD03_Hg2_Hg0 (TYPE (XPLEX)) : Array for Hg(II) produced from Hg(0)
!  (3 ) AD03_Hg2_OH  (TYPE (XPLEX)) : Array for Hg(II) produced from OH
!  (4 ) AD03_Hg2_O3  (TYPE (XPLEX)) : Array for Hg(II) produced from O3
!
!  Module Routines:
!  ============================================================================
...
!
      ...
      TYPE (XPLEX),  ALLOCATABLE :: AD03_Hg2_Hg0(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: AD03_Hg2_OH(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: AD03_Hg2_O3(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: AD03_Hg2_SS(:,:,:)
...
!$OMP+SCHEDULE( DYNAMIC )
      ...
      DO I = 1, IIPAR
         ...
         AD03_Hg2_Hg0(I,J,L) = 0d0
         AD03_Hg2_OH(I,J,L)  = 0d0
         AD03_Hg2_O3(I,J,L)  = 0d0
