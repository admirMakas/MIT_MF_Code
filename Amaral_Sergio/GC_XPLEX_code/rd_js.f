C $Id: rd_js.f,v 1.1.1.1 2009/06/09 21:51:53 daven Exp $
...
c                     Read in quantum yield jfacta and fastj label jlabel
 ...
 10   read(nj1,'(a)',err=20) cline
      ...
      elseif(cline(5:5).eq.'$') then
         ...
         ipr=ipr+1
         read(cline(79:83),'(f5.1)') d_jfacta(ipr)
         jfacta(ipr) = xplx(d_jfacta(ipr)) 
...
c
 ...
 1200 format(3x,10(3(i2,': ',a7,' (Q.Y. ',2f5.3,') '),/,3x))
      end
