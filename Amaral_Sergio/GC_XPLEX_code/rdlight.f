! $Id: rdlight.f,v 1.1.1.1 2009/06/09 21:51:53 daven Exp $
      SUBROUTINE RDLIGHT
!
!******************************************************************************
...
#     include "CMN_ISOP"  ! SOPCOEFF
 ...
 100  FORMAT( '     - RDLIGHT: Reading ', a )
      ...
      ! Read data
      READ( IU_FILE,'(8(1PE10.2))',IOSTAT=IOS)(D_SOPCOEFF(I), I=1,NPOLY)
      IF ( IOS /= 0 ) CALL IOERROR( IOS, IU_FILE, 'rdlight:3' )
      SOPCOEFF(:) = (D_SOPCOEFF(:))
      ! Close file
      CLOSE( IU_FILE )
      !print*,'SOPCOEF',SOPCOEFF
