...
#     include "CMN"           ! LPAUSE, for backwards compatibility
      ...
      ! Local Variables
      INTEGER            :: I, J
      TYPE (XPLEX)             :: TPAUSE_LEV(IIPAR,JJPAR)
...
!  (5 ) Call TRANSFER_2D from "transfer_mod.f" to cast data from TYPE (XPLEX) to
...
#     include "CMN"           ! LPAUSE, for backwards compatibility
 ...
 110  FORMAT( '     - READ_TROPOPAUSE: Reading ', a )
     ...
     &                 1,         ARRAY,     QUIET=.TRUE. )
      ...
      ! Copy from TYPE (XPLEX) to INTEGER and resize to (IIPAR,JJPAR)
