! $Id: get_global_ch4.f,v 1.1.1.1 2009/06/09 21:51:51 daven Exp $
...
!  Arguments as Output:
!  ===========================================================================
!  (3 ) A3090S      (TYPE (XPLEX) ) : CH4 concentration [ppbv], 90S - 30S lat
!  (4 ) A0030S      (TYPE (XPLEX) ) : CH4 concentration [ppbv], 30S - 00  lat
!  (5 ) A0030N      (TYPE (XPLEX) ) : CH4 concentration [ppbv], 00  - 30N lat
!  (6 ) A3090N      (TYPE (XPLEX) ) : CH4 concentration [ppbv], 30N - 90N lat
!
!  NOTES:
...
!
      ...
      TYPE (XPLEX),  INTENT(OUT)      :: A3090S, A0030S, A0030N, A3090N
...
!$OMP CRITICAL
 ...
 110  FORMAT( 'CH4 (90N - 30N) : ', 2f7.1, ' [ppbv]', /,
     &        'CH4 (30N - 00 ) : ', 2f7.1, ' [ppbv]', /,
     &        'CH4 (00  - 30S) : ', 2f7.1, ' [ppbv]', /,
     &        'CH4 (30S - 90S) : ', 2f7.1, ' [ppbv]' )
