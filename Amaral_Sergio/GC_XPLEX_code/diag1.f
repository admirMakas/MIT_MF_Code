! $Id: diag1.f,v 1.1.1.1 2009/06/09 21:51:50 daven Exp $
      SUBROUTINE DIAG1 
!
!******************************************************************************
...
#     include "CMN_GCTM"  ! Physical constants
      ...
      TYPE (XPLEX)             :: FDTT, XLOCTM, AREA_M2
      TYPE (XPLEX)             :: STT_VV(IIPAR,JJPAR,LLPAR,N_TRACERS)
...
!$OMP+PRIVATE( I, J )
         DO J = 1, JJPAR
         DO I = 1, IIPAR
            IF ( IS_WATER( I, J ) ) AD30(I,J) = AD30(I,J) + 0d0
            IF ( IS_LAND ( I, J ) ) AD30(I,J) = AD30(I,J) + 1d0
            IF ( IS_ICE  ( I, J ) ) AD30(I,J) = AD30(I,J) + 2d0
         ENDDO
         ENDDO
!$OMP END PARALLEL DO
      ENDIF
