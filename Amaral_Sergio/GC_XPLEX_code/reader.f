...
C
      ...
      TYPE (XPLEX)              :: ERRMAXU, YLOWU, YHIU, HMAXDAYU
      TYPE (XPLEX)              :: ERRMAXR, YLOWR, YHIR, HMAXDAYR
      TYPE (XPLEX)              :: ERRMAXS, YLOWS, YHIS, HMAXDAYS
      TYPE (XPLEX)              :: ABHI,    ABLO
...
C
       DO 270 I       = 2, 5 
        ABTOL(I,NCS)  = 10.d0**(ABLO + (ABHI - ABLO)*XPLX(6-I)/5.d0)
 270   CONTINUE 
 272  CONTINUE
C
C *********************************************************************
