...
#     include "comode.h"     ! IHOUR
      ...
      TYPE (XPLEX)                :: TODX, DTSRCE, AREA_CM2           
      TYPE (XPLEX)                :: EMX(NOXLEVELS)  
      TYPE (XPLEX)                :: XEMISR
      TYPE (XPLEX)                :: XEMISRN(NOXLEVELS)
      TYPE (XPLEX)               :: BRAVO, EPA_NEI, EMEP, EDGAR, STREETS
      TYPE (XPLEX)                :: CAC,   SHIP,    VISTAS, NEI05
...
! LICOADSSHIP not implemented yet
