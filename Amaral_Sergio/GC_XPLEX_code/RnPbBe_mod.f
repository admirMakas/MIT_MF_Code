! $Id: RnPbBe_mod.f,v 1.1.1.1 2009/06/09 21:51:53 daven Exp $
      MODULE RnPbBe_MOD
!
!******************************************************************************
...
!
      ...
      ! MODULE VARIABLES
      !=================================================================
      TYPE (XPLEX)            :: LATSOU(10), PRESOU(33), BESOU(10,33)
      TYPE (XPLEX),PARAMETER::XNUMOL_Rn=xplex(6.0225d23/222.0d-3,0d0)    
      TYPE (XPLEX),PARAMETER::XNUMOL_Pb=xplex(6.0225d23/210.0d-3,0d0)    
      TYPE (XPLEX),PARAMETER::XNUMOL_Be=xplex(6.0225d23/7.0d-3,0d0)
...
!  ============================================================================
!  (1  ) EMISSION (TYPE (XPLEX))  : Emissions to be corrected [kg]
!
!  NOTES:
...
#     include "define.h"    ! Switches
      ...
      ! Arguments
      TYPE (XPLEX), INTENT(INOUT) :: EMISSION
...
#     include "CMN_DEP"  ! FRCLND
      ...
      INTEGER            :: I,          J,          L,         N
      TYPE (XPLEX)         :: A_CM2,      ADD_Be,     ADD_Rn,    Rn_LAND
      TYPE (XPLEX)          :: Rn_WATER,   DTSRCE,     LAT_TMP,   P_TMP
      TYPE (XPLEX)          :: Be_TMP,     Rn_TMP,     LAT_S,     LAT_N
      TYPE (XPLEX)        :: LAT_H,      LAT_L,      F_LAND,    F_WATER
      TYPE (XPLEX)             :: F_BELOW_70, F_BELOW_60, F_ABOVE_60
...
#     include "CMN_DIAG" ! ND01, ND02
      ...
      INTEGER           :: I, J, L, N            
      TYPE (XPLEX)            :: ADD_Pb, Be_LOST ,DTCHEM, Pb_LOST 
      TYPE (XPLEX)            :: Rn_LOST(IIPAR,JJPAR,LLPAR)

      ! Static variables
      TYPE (XPLEX), SAVE      :: EXP_Rn, EXP_Pb, EXP_Be

      ! Ratio of molecular weights of 210Pb/222Rn
      TYPE (XPLEX), PARAMETER :: Pb_Rn_RATIO = xplex(210d0 / 222d0,0d0)
...
!  Arguments as Input:
!  ============================================================================
!  (1 ) X (TYPE (XPLEX)) : X-axis coordinate on original grid
!  (2 ) Y (TYPE (XPLEX)) : Y-axis coordinate on original grid
!  (3 ) Z (TYPE (XPLEX)) : Array of data on original grid
!  (4 ) N (TYPE (XPLEX)) : First dimension of Z
!  (5 ) M (TYPE (XPLEX)) : Second dimension of Z
!  (6 ) U (TYPE (XPLEX)) : X-axis coordinate for desired interpolated value
!  (7 ) V (TYPE (XPLEX)) : Y-axis coordinate for desired interpolated value
!
!  Arguments as Output:
!  ============================================================================
!  (8 ) W (TYPE (XPLEX)) : Interpolated value of Z array, at coordinates (U,V) 
!
!  NOTES:
