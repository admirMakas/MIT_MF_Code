! $Id: diag50_mod.f,v 1.1.1.1 2009/06/09 21:51:53 daven Exp $
      MODULE DIAG50_MOD
!
!******************************************************************************
...
!  (21) Q                (TYPE (XPLEX)  ) : Accumulator array for various quantities
!  (22) TAU0             (TYPE (XPLEX)  ) : Starting TAU used to index the bpch file
!  (23) TAU1             (TYPE (XPLEX)  ) : Ending TAU used to index the bpch file
!  (24) HALFPOLAR        (INTEGER ) : Used for bpch file output
!  (25) CENTER180        (INTEGER ) : Used for bpch file output
!  (26) LONRES           (TYPE (XPLEX)  ) : Used for bpch file output
!  (27) LATRES           (TYPE (XPLEX)  ) : Used for bpch file output
...
!$OMP END PARALLEL DO
     ...
     &              ( Q(1:ND50_NI, 1:ND50_NJ, 1:GMNL, W) ) )
      ENDDO
