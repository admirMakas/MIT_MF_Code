! $Id: biofuel_mod.f,v 1.2 2011/02/23 00:08:47 daven Exp $
      MODULE BIOFUEL_MOD
!
!******************************************************************************
...
!
      ...
      TYPE (XPLEX), ALLOCATABLE :: BIOFUEL(:,:,:)
      TYPE (XPLEX), ALLOCATABLE :: BIOFUEL_KG(:,:,:)
...
!        cast data from TYPE (XPLEX) to COMPLEX*16 and copy to BIOFUEL (bmy, 9/28/01)
...
#     include "CMN_O3"               ! FSCLYR
      ...
      TYPE (XPLEX),  SAVE                 :: MOLWT(NBFMAX)
      TYPE (XPLEX)                        :: TOTAL, BXHEIGHT_CM, EPA_NEI
      CHARACTER(LEN=255)            :: FILENAME 
      
      ! External functions
      TYPE (XPLEX),  EXTERNAL             :: BOXVL

      TYPE (XPLEX)                        :: BF_CO( IIPAR, JJPAR )  ! Biofuel emission of CO [molec/cm2/s]
     ...
     &                          1,         ARRAY,     QUIET=.TRUE. ) 
               ...
               ! Cast from TYPE (XPLEX) to COMPLEX*16, resize to (IIPAR,JJPAR)
...
!$OMP END PARALLEL DO
 ...
 120  FORMAT( 'Sum Biofuel ', a4, 1x, ': ', 2f9.3, 1x, a9  )
...
!  Arguments as Input:
!  ============================================================================
!  (1) BFARRAY (TYPE (XPLEX)) : Array containing biofuel burning CO emissions
!
!  NOTES:
...
#     include "CMN_SIZE"    ! Size parameters
      ...
      ! Arguments
      TYPE (XPLEX), INTENT(INOUT) :: BFARRAY(IIPAR,JJPAR) 
...
!  Arguments as Input:
!  ============================================================================
!  (1) BFARRAY (TYPE (XPLEX)) : Array containing biofuel burning ACET emissions
!
!  Reference:
!  ============================================================================
...
!  (2 ) BF   (TYPE (XPLEX)   ) : Array w/ biomass burning emisisons [molec/cm2]
!
!  NOTES:
!******************************************************************************
!
...
#     include "CMN_SIZE"               ! Size parameters
      ...
      ! Arguments
      TYPE (XPLEX),           INTENT(INOUT) :: BF(IIPAR,JJPAR)
