! $Id: rdsoil.f,v 1.1.1.1 2009/06/09 21:51:54 daven Exp $
      SUBROUTINE RDSOIL
!
!******************************************************************************
...
!  (3 ) SOILFERT  (TYPE (XPLEX) ) : Array containing fertilizer NOx [ng N/m2/s]  
!  (4 ) SOILPREP  (TYPE (XPLEX) ) : Array containing 2 months of observed
...
#     include "commsoil.h" ! Soil variables
 ...
 100     FORMAT( '     - RDSOIL: Reading ', a )
     ...
     &           ( INDEXSOIL(I,M), I=1,2 ), SOILFERT(M)%r
     ...
     &              GET_RES_EXT()    // '.dat'
         ...
         DO M = 1, NLAND
            ...
            READ( IUNIT, *, IOSTAT=IOS ) I, J, ( TMP(K)%r, K=1,12 )
