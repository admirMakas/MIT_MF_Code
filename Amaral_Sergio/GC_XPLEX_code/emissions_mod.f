...
!
      ...
      USE AIRCRAFT_MOD,           ONLY : EMISS_AIRCRAFT, LAIRCRAFT !jkoo
...
! !LOCAL VARIABLES:
!
      INTEGER                     :: MONTH, YEAR,I,J,L,N
      TYPE (XPLEX)                      :: BIOMASS(IIPAR,JJPAR,NBIOMAX)
...
!----------------
     ...
     &        CALL EMISS_VISTAS_ANTHRO
         ...
         IF ( LAIRCRAFT ) CALL EMISS_AIRCRAFT !jkoo
