! $Id: smvgear.f,v 1.1.1.1 2009/06/09 21:51:52 daven Exp $
      SUBROUTINE SMVGEAR
!
!******************************************************************************
...
C
      ...
      TYPE (XPLEX) NYLOWDEC,ORDER,HRMAX,YFAC,ERRINIT,
     & RELTOL1,RELTOL2,RELTOL3
      TYPE (XPLEX) ABTOLER1,ABTOLER2,HRATIO,ASN1,
     & RDELMAX,CNW,CNEWYLOW,ERRYMAX
      TYPE (XPLEX) RMSTOP,DELT1,ENQQ,EUP,EDWN,
     & CONP3,CONP2,CONP1,HMTIM,RDELTA
      TYPE(XPLEX) CONC3J3,CONC4J4,CONC10J5,CONC5J5,DRATE,RMSERRP,DER2MAX
      TYPE (XPLEX) RMSRAT,DCON,RDELTUP,ASNQQJ,
     & DER3MAX,RDELTSM,DER1MAX,RDELTDN
      TYPE (XPLEX) CONSMULT
      ...
      TYPE (XPLEX)             :: DELY(KBLOOP),   ERRHOLD(KBLOOP)
      TYPE (XPLEX)             :: YABST(KBLOOP)
      ...
      TYPE (XPLEX)             :: DTFORCE  
      TYPE (XPLEX)             :: CPREVM( KBLOOP, MXGSAER )
      !-----------------------------------------------------------------------
...
C
      ELSEIF (RDELT.EQ.RDELTUP) THEN
       CONSMULT         = ASET(NQQ,KSTEP) /XPLX(KSTEP)
       NQQ              = KSTEP
       NQISC            = NQQ * ISCHAN
