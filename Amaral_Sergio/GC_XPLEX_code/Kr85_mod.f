! $Id: Kr85_mod.f,v 1.1.1.1 2009/06/09 21:51:52 daven Exp $
      MODULE Kr85_MOD
!
!******************************************************************************
...
!  (3 ) SMALLNUM  (TYPE (XPLEX) ) : A small number, used to prevent underflow
!
!  Module Routines:
!  ============================================================================
...
!
      ...
      ! Local variables
      TYPE (XPLEX)               :: Kr85, DTSRCE
      TYPE (XPLEX), PARAMETER::SEC_PER_YR=xplex(86400d0 * 365.25d0,0d0)

      ! Kr85 point src emissions
      ! Units: MCi/year     Year1  Year2  Year3  Year4  Year5  Year6
      TYPE(XPLEX)::S1(6)=(/ xplex(0.48d0,0d0),xplex(0.46d0,0d0),
     & xplex(0.47d0,0d0),xplex(0.54d0,0d0),xplex(0.56d0,0d0),
     & xplex(0.69d0,0d0) /)
      TYPE(XPLEX)::S2(6)=(/ xplex(0.10d0,0d0),xplex(0.00d0,0d0),
     & xplex(0.09d0,0d0),xplex(0.06d0,0d0),xplex(0.01d0,0d0),
     & xplex(0.00d0,0d0) /)
      TYPE(XPLEX)::S3(6)=(/ xplex(0.70d0,0d0),xplex(0.94d0,0d0),
     & xplex(0.84d0,0d0),xplex(1.40d0,0d0),xplex(1.19d0,0d0),
     & xplex(1.13d0,0d0) /)
      TYPE(XPLEX)::S4(6)=(/ xplex(0.31d0,0d0),xplex(0.28d0,0d0),
     & xplex(0.54d0,0d0),xplex(0.31d0,0d0),xplex(0.31d0,0d0),
     & xplex(0.31d0,0d0) /)
      TYPE(XPLEX)::S5(6)=(/ xplex(0.79d0,0d0),xplex(0.64d0,0d0),
     & xplex(0.83d0,0d0),xplex(0.91d0,0d0),xplex(1.27d0,0d0),
     & xplex(1.95d0,0d0) /)
      TYPE(XPLEX)::S6(6)=(/ xplex(0.00d0,0d0),xplex(0.05d0,0d0),
     & xplex(0.03d0,0d0),xplex(0.00d0,0d0),xplex(0.00d0,0d0),
     & xplex(0.08d0,0d0) /)
      TYPE(XPLEX)::S7(6)=(/ xplex(0.06d0,0d0),xplex(0.00d0,0d0),
     & xplex(0.28d0,0d0),xplex(0.11d0,0d0),xplex(0.19d0,0d0),
     & xplex(0.09d0,0d0) /)
      TYPE(XPLEX)::S8(6)=(/ xplex(3.56d0,0d0),xplex(3.77d0,0d0),
     & xplex(3.19d0,0d0),xplex(3.07d0,0d0),xplex(3.00d0,0d0),
     & xplex(2.40d0,0d0) /)
...
#     include "CMN_DIAG" ! ND03
      ...
      ! Local variables
      INTEGER :: I,      J,     L
      TYPE (XPLEX)  :: DTCHEM, KRATE, LOSS_FACTOR, Kr_LOST
