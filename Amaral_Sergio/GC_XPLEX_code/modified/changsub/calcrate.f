! $Id: calcrate.f,v 1.1.1.1 2009/06/09 21:51:54 daven Exp $
...
C *********************************************************************
C               SAVE A COPY OF THE RATES FOR KPP SOLVER  (dkh, 06/20/05)
C *********************************************************************
C
      DO NK          = 1, NTRATES(NCS)

         ! dkh debug
         !print*, 'NTRATES = ', ntrates
         !print*, 'NEWFOLD(:,NCS) = ', NEWFOLD(:,NCS)

         DO KLOOP      = 1, KTLOOP
            ! some of these NTRATES rates are undefined. Skip them
            ! so that we don't access element 0 of RRATE, triggering 
            ! an array out of bounds error.  (dkh, 10/25/05)  
