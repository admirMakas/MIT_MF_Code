...
!  (6 ) XMID_G     (TYPE (XPLEX) ) : GLOBAL array of grid-box lon centers [degrees]
!  (7 ) XEDGE_G    (TYPE (XPLEX) ) : GLOBAL array of grid-box lon edges   [degrees]
!  (8 ) YMID_G     (TYPE (XPLEX) ) : GLOBAL array of grid-box lat centers [degrees]
!  (9 ) YEDGE_G    (TYPE (XPLEX) ) : GLOBAL array of grid-box lat edges   [degrees]
!  (10) YMID_R_G   (TYPE (XPLEX) ) : GLOBAL array of grid-box lat centers [radians]
!  (11) YEDGE_R_G  (TYPE (XPLEX) ) : GLOBAL array of grid-box lat edges   [radians]
!  (12) AREA_M2_G  (TYPE (XPLEX) ) : GLOBAL array of grid-box surface areas [m2]
!  (13) AREA_CM2_G (TYPE (XPLEX) ) : GLOBAL array of grid-box surface areas [cm2]
!  (14) XMID       (TYPE (XPLEX) ) : WINDOW array of grid-box lon centers [degrees]
!  (15) XEDGE      (TYPE (XPLEX) ) : WINDOW array of grid-box lon edges   [degrees]
!  (16) YMID       (TYPE (XPLEX) ) : WINDOW array of grid-box lat centers [degrees]
!  (17) YEDGE      (TYPE (XPLEX) ) : WINDOW array of grid-box lat edges   [degrees]
!  (18) YMID_R     (TYPE (XPLEX) ) : WINDOW array of grid-box lat centers [radians]
!  (19) YEDGE_R    (TYPE (XPLEX) ) : WINDOW array of grid-box lat edges   [radians]
!  (20) AREA_M2    (TYPE (XPLEX) ) : WINDOW array of grid-box surface areas [m2]
!  (21) AREA_CM2   (TYPE (XPLEX) ) : WINDOW array of grid-box surface areas [cm2]
!
!  Module Routines:
!  ============================================================================
...
!
      ...
      TYPE (XPLEX),  ALLOCATABLE :: XMID_G(:),    XEDGE_G(:)
      TYPE (XPLEX),  ALLOCATABLE :: YMID_G(:),    YEDGE_G(:)
      TYPE (XPLEX),  ALLOCATABLE :: YMID_R_G(:),  YEDGE_R_G(:)
      TYPE (XPLEX),  ALLOCATABLE :: AREA_M2_G(:), AREA_CM2_G(:)
      TYPE (XPLEX),  ALLOCATABLE :: XMID(:),      XEDGE(:)
      TYPE (XPLEX),  ALLOCATABLE :: YMID(:),      YEDGE(:)
      TYPE (XPLEX),  ALLOCATABLE :: YMID_R(:),    YEDGE_R(:)
      TYPE (XPLEX),  ALLOCATABLE :: YMID_R_W(:),  YEDGE_R_W(:)
      TYPE (XPLEX),  ALLOCATABLE :: AREA_M2(:),   AREA_CM2(:)
...
!  Arguments as Input:
!  ============================================================================
!  (1 ) COORDS  (TYPE (XPLEX))  : Contains (/LON_LL, LAT_LL, LON_UR, LAT_UR/) values
!
!  Arguments as Output:
!  ============================================================================
