...
#     include "CMN_GCTM"       ! Rdg0
      ...
      TYPE (XPLEX)                  :: P1, P2, P3, T1, T2, DZ, ZUP
      TYPE (XPLEX)                  :: DTDYN, H70mb, PO3, PO3_vmr
      TYPE (XPLEX)                  :: STFLUX(IIPAR,JJPAR,LLPAR)
      ...
      ! TYPE (XPLEX),  PARAMETER   :: P70mb = 70d0 !PHS
      TYPE (XPLEX)  :: P70mb, PTP
...
!        TYPE (XPLEX) and resize arrays to (JJPAR,LLPAR) (bmy, 9/27/01)
...
#     include "CMN_SIZE"   ! Size parameters
      ...
      ! Change to TYPE (XPLEX) to prevent overflow in adjoint (tww, dkh, 01/08/12, adj32_008) 
...
#     include "CMN_GCTM"     ! Rdg0
      ...
      INTEGER               :: NTRACER
      TYPE (XPLEX)                :: P1, P2, P3, T1, T2, DZ, ZUP
      TYPE (XPLEX)                :: DTDYN, H70mb, PO3_vmr!,PO3
      TYPE (XPLEX)                :: PHD, PHD_vmr, SCALE_HD!, HD_AVG
      ...
      TYPE (XPLEX),  PARAMETER   :: P70mb = xplex(70d0,0d0)
