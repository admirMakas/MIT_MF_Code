...
C
      ! Arguments
      TYPE (XPLEX), INTENT(IN) :: SUNCOS(MAXIJ), SUNCOSB(MAXIJ)
      ...
      TYPE (XPLEX) S1CON,S2CON,ARGS,CONSTQ,SNOON,CONTEMP,DIFCONC,PLODYN
      TYPE (XPLEX) PR3,RIS,RST,TBEGIN,TFINISH,VALLOW,CLO1,CLO2,SUMFRACS
      TYPE (XPLEX)SUMRMS,SUMHI,SUMRMSH,CMOD,CGOOD,FRACDIF,FRACABS,AVGERR
      TYPE (XPLEX) RMSCUR,AVGHI,RMSCURH,FSTEPT,FITS,TSTEPIT,PHIDYN
      TYPE (XPLEX) GMU
