! $Id: a3_read_mod.f,v 1.2 2012/03/01 22:00:26 daven Exp $
      MODULE A3_READ_MOD
!
!******************************************************************************
...
#     include "CMN_DIAG"             ! ND67
      ...
      ! Arguments
      INTEGER, INTENT(IN)            :: NYMD, NHMS
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: ALBEDO(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: CLDFRC(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: EVAP(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: GRN(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: GWETROOT(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: GWETTOP(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: HFLUX(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: LAI(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: MOLENGTH(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: OICE(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: PARDF(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: PARDR(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: PBL(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: PREACC(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: PRECON(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: PRECSNO(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: RADLWG(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: RADSWG(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: RADSWT(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: SNICE(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: SNODP(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: SNOMAS(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: SNOW(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: TROPP(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: TS(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: TSKIN(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: U10M(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: USTAR(IIPAR,JJPAR) 
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: V10M(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: Z0(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: FRLAND(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: FRLAKE(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: FROCEAN(IIPAR,JJPAR)
      TYPE (XPLEX),  INTENT(OUT), OPTIONAL :: FRLANDIC(IIPAR,JJPAR)
      ...
      DO
         ...
         SELECT CASE ( TRIM( NAME ) )
            ...
            !--------------------------------
            CASE ( 'ALBEDO' ) 
               READ( IU_A3, IOSTAT=IOS ) XYMD, XHMS, D_Q2
...
!  Arguments as Input:
!  ============================================================================
!  (1 ) FIELD (TYPE (XPLEX) ) : Met field array to be archived into ND67
...
#     include "CMN_SIZE"  ! Size parameters
      ...
      ! Arguments
      INTEGER, INTENT(IN) :: N
      TYPE (XPLEX),  INTENT(IN) :: FIELD(MAXIJ)
