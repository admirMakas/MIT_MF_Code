...
! (yhmao, dkh, 01/13/12, adj32_013) 
      ...
      !=================================================================      
      !STT(22,33,1,IDTSO2)%i=1d-120*STT(22,33,1,IDTSO2)%r
...
!          print*,'STT beg dyn time loop',STT(i,j,l,n),n,i,j,l,n_step
!          CALL GEOS_CHEM_STOP
!      endif
!      enddo
!      enddo
...
!      do i=1,size(STT,1)
!      if (abs(STT(i,j,l,n)%i)>1e-210) then
!          print*,'STT unit conv',STT(i,j,l,n),n,i,j,l,n_step
!          CALL GEOS_CHEM_STOP
!      endif
!      enddo
!      enddo
...
!      do i=1,size(STT,1)
!      if (abs(STT(i,j,l,n)%i)>1e-210) then
!          print*,'STT transport',STT(i,j,l,n),n,i,j,l,n_step
!          CALL GEOS_CHEM_STOP
!      endif
!      enddo
!      enddo
...
!      do i=1,size(STT,1)
!      if (abs(STT(i,j,l,n)%i)>1e-210) then
!          print*,'STT conv',STT(i,j,l,n),n,i,j,l,n_step
!          CALL GEOS_CHEM_STOP
!      endif
!      enddo
!      enddo
...
!      do i=1,size(STT,1)
!      if (abs(STT(i,j,l,n)%i)>1e-210) then
!          print*,'STT drydep',STT(i,j,l,n),n,i,j,l,n_step
!          CALL GEOS_CHEM_STOP
!      endif
!      enddo
!      enddo
...
!      do i=1,size(STT,1)
!      if (abs(STT(i,j,l,n)%i)>1e-210) then
!          print*,'STT emission',STT(i,j,l,n),n,i,j,l,n_step
!          CALL GEOS_CHEM_STOP
!      endif
!      enddo
!      enddo
...
!      do i=1,size(STT,1)
!      if (abs(STT(i,j,l,n)%i)>1e-210) then
!          print*,'STT chemistry',STT(i,j,l,n),n,i,j,l,n_step
!          CALL GEOS_CHEM_STOP
!      endif
!      enddo
!      enddo
...
! (yhmao, dkh, 01/13/12, adj32_013) 
     ...
     &           ITS_A_FULLCHEM_SIM() .and. JLOP(IFD,JFD,LFD) > 0 ) THEN
               print*, ' CSPEC write = ', 
...
!
!      ! Arguments
!      TYPE (XPLEX)    :: TCKG(IIPAR,JJPAR,LLPAR,N_TRACERS)
!
!      ! Local variables
!      INTEGER   :: I, J, L, N
!
