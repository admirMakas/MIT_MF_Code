...
!  Arguments as Input:
!  ============================================================================
!  (1 ) EMISRR   (TYPE (XPLEX) ) : CO, hydrocarbon emission   [molec tracer/box/s ]
!  (2 ) EMISRRN  (TYPE (XPLEX) ) : Multi-level NOx emissions  [molec NOx/box/s    ]
!
...
!      USE AIRCRAFT_NOX_MOD,  ONLY : EMIS_AC_NOx !jkoo
      ...
      ! dkh debug
      USE ADJ_ARRAYS_MOD,    ONLY : IFD, LFD, JFD
...
#     include "comode.h"  ! IDEMS, NEMIS
      ...
      ! Arguments
      TYPE (XPLEX),  INTENT(IN) :: EMISRR(IIPAR,JJPAR,NEMPARA+NEMPARB)
      TYPE (XPLEX),  INTENT(IN) :: EMISRRN(IIPAR,JJPAR,NOXEXTENT)  
