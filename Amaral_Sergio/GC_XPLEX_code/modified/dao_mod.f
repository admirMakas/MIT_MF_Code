...
!  Module Variables:
!  ============================================================================
!  (1 ) ALBD1    (TYPE (XPLEX) ) : Sfc albedo at start of 6h step      [unitless]
!  (2 ) ALBD2    (TYPE (XPLEX) ) : Sfc albedo at end   of 6h step      [unitless]
!  (3 ) ALBD     (TYPE (XPLEX) ) : Interpolated surface albedo         [unitless] 
!  (4 ) LWI      (TYPE (XPLEX) ) : Land-Water flags                    [unitless]
!  (5 ) PS1      (TYPE (XPLEX) ) : Sfc pressure at start of 6h  step   [hPa]
!  (6 ) PS2      (TYPE (XPLEX) ) : Sfc pressure at end   of 6h  step   [hPa] 
!  (7 ) PSC2     (TYPE (XPLEX) ) : Sfc pressure at end   of dyn step   [hPa]
!  (8 ) SLP      (TYPE (XPLEX) ) : Sea level pressure (GEOS-3)         [hPa]
!  (9 ) SPHU1    (TYPE (XPLEX) ) : Spec. Humidity at start of 6h step  [g H2O/kg air]
!  (10) SPHU2    (TYPE (XPLEX) ) : Spec. Humidity at end   of 6h step  [g H2O/kg air]
!  (11) SPHU     (TYPE (XPLEX) ) : Interpolated specific humidity      [g H2O/kg air]
!  (12) TMPU1    (TYPE (XPLEX) ) : Temperature at start of 6h step     [K]
!  (13) TMPU2    (TYPE (XPLEX) ) : Temperature at end   of 6h step     [K]
!  (14) T        (TYPE (XPLEX) ) : Interpolated temperature            [K]  
!  (15) TROPP1   (TYPE (XPLEX) ) : Tropopause pressure at start        [hPa]      
!  (16) TROPP2   (TYPE (XPLEX) ) : Tropopause pressure at end of step  [hPa]      
!  (17) TROPP    (TYPE (XPLEX) ) : Interpolated tropopause pressure    [hPa]      
!  (18) UWND1    (TYPE (XPLEX) ) : Zonal wind at start of 6h step      [m/s]
!  (19) UWND2    (TYPE (XPLEX) ) : Zonal wind at end   of 6h step      [m/s]
!  (20) UWND     (TYPE (XPLEX) ) : Interpolated zonal wind             [m/s]
!  (21) VWND1    (TYPE (XPLEX) ) : Meridional wind at start of 6h step [m/s]
!  (22) VWND2    (TYPE (XPLEX) ) : Meridional wind at end of 6h step   [m/s]
!  (23) VWND     (TYPE (XPLEX) ) : Interpolated meridional wind        [m/s]
!  (24) CLDTOPS  (INTEGER) : Cloud top height level              [unitless]
!  (25) CLDMAS   (TYPE (XPLEX) ) : Cloud mass flux                     [kg/m2/600s]
!  (26) DTRAIN   (TYPE (XPLEX) ) : Cloud detrainment                   [kg/m2/600s]
!  (27) HKBETA   (TYPE (XPLEX) ) : GEOS-4 Hack overshoot parameter     [unitless]
!  (28) HKETA    (TYPE (XPLEX) ) : GEOS-4 Hack convective mass flux    [kg/m2/s]
!  (29) MOISTQ   (TYPE (XPLEX) ) : Tendency of SPHU field          [g H2O/kg air/day]
!  (30) CLMOSW   (TYPE (XPLEX) ) : GEOS-1 max overlap cloud fraction   [unitless]
!  (31) CLROSW   (TYPE (XPLEX) ) : GEOS-1 random overlap cloud frac.   [unitless]
!  (32) CLDF     (TYPE (XPLEX) ) : Total 3-D cloud fraction            [unitless]
!  (33) OPTDEP   (TYPE (XPLEX) ) : GEOS-3 grid box optical depth       [unitless]
!  (34) OPTD     (TYPE (XPLEX) ) : Grid box optical depth (all grids)  [unitless]
!  (35) ZMEU     (TYPE (XPLEX) ) : GEOS-4 Z&M updraft entrainment      [Pa/s]
!  (36) ZMMD     (TYPE (XPLEX) ) : GEOS-4 Z&M downdraft mass flux      [Pa/s]
!  (37) ZMMU     (TYPE (XPLEX) ) : GEOS-4 Z&M updraft mass flux        [Pa/s]
!  (38) GWETTOP  (TYPE (XPLEX) ) : GEOS-4 topsoil wetness              
!  (39) HFLUX    (TYPE (XPLEX) ) : Sensible heat flux                  [W/m2]
!  (40) PARDF    (TYPE (XPLEX) ) : Photosyn active diffuse radiation   [W/m2]
!  (41) PARDR    (TYPE (XPLEX) ) : Photosyn active direct radiation    [W/m2]
!  (42) PBL      (TYPE (XPLEX) ) : Mixed layer depth                   [hPa]
!  (43) PREACC   (TYPE (XPLEX) ) : Total precip at the ground          [mm H2O/day]
!  (44) PRECON   (TYPE (XPLEX) ) : Convective precip at the ground     [mm H2O/day]
!  (45) RADLWG   (TYPE (XPLEX) ) : Net upward LW rad at the ground     [W/m2]
!  (46) RADSWG   (TYPE (XPLEX) ) : Net downward SW rad at the ground   [W/m2]
!  (47) SNOW     (TYPE (XPLEX) ) : Snow cover (H2O equivalent)         [mm H2O]
!  (48) TS       (TYPE (XPLEX) ) : Surface air temperature             [K]
!  (49) TSKIN    (TYPE (XPLEX) ) : Surface ground/sea surface temp     [K]
!  (50) U10M     (TYPE (XPLEX) ) : Zonal wind at 10 m altitude         [m/s]
!  (51) USTAR    (TYPE (XPLEX) ) : Friction velocity                   [m/s]
!  (52) V10M     (TYPE (XPLEX) ) : Meridional wind at 10 m altitude    [m/s]
!  (53) Z0       (TYPE (XPLEX) ) : Roughness height                    [m]
!  (52) DETRAINE (TYPE (XPLEX))  : Detrainment flux (entr. plume)
!  (53) DETRAINN (TYPE (XPLEX))  : Detrainment flux (non-entr. plume)
!  (54) DNDE     (TYPE (XPLEX))  : Downdraft (entraining plume) 
!  (55) DNDN     (TYPE (XPLEX))  : Downdraft (non-entraining plume)
!  (56) ENTRAIN  (TYPE (XPLEX))  : Entrainment flux
!  (57) LWI_GISS (TYPE (XPLEX))  : Fraction of land cover
!  (58) MOLENGTH (TYPE (XPLEX))  : Monin-Obhukov length
!  (59) OICE     (TYPE (XPLEX))  : Ocean ice ??
!  (60) SNICE    (TYPE (XPLEX))  : Snow ice ??
!  (61) UPDE     (TYPE (XPLEX))  : Updraft (entraining plume)
!  (62) UPDN     (TYPE (XPLEX))  : Updraft (non-entraining plume)
!  (63) AD       (TYPE (XPLEX) ) : Dry air mass                        [kg]
!  (64) AIRVOL   (TYPE (XPLEX) ) : Volume of air in grid box           [m3]
!  (65) AIRDEN   (TYPE (XPLEX) ) : Density of air in grid box          [kg/m3]
!  (66) AVGW     (TYPE (XPLEX) ) : Mixing ratio of water vapor         [v/v]
!  (67) BXHEIGHT (TYPE (XPLEX) ) : Grid box height                     [m]
!  (68) DELP     (TYPE (XPLEX) ) : Pressure thickness of grid box      [hPa]
!  (69) OBK      (TYPE (XPLEX) ) : Monin-Obhukov length                [m]
!  (70) RH       (TYPE (XPLEX) ) : Relative humidity                   [%]
!  (71) SUNCOS   (TYPE (XPLEX) ) : COSINE( solar zenith angle )        [unitless]
!  (72) SUNCOSB  (TYPE (XPLEX) ) : COSINE( SZA ) at next chem time     [unitless]
!
!  Module Routines:
!  ============================================================================
...
!
      ...
      ! Arrays
      TYPE (XPLEX),  ALLOCATABLE :: AD(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: AIRDEN(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: AIRVOL(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: ALBD1(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: ALBD2(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: ALBD (:,:)
      TYPE (XPLEX),  ALLOCATABLE :: AVGW(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: BXHEIGHT(:,:,:)
      INTEGER, ALLOCATABLE :: CLDTOPS(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: CLDF(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: CLDMAS(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: CLDFRC(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: CMFMC(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DELP(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DETRAINE(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DETRAINN(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DNDE(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DNDN(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DQIDTMST(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DQLDTMST(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DQRCON(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DQRLSC(:,:,:)    
      TYPE (XPLEX),  ALLOCATABLE :: DQVDTMST(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: DTRAIN(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: ENTRAIN(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: EVAP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: FRLAND(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: FROCEAN(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: FRLANDIC(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: FRLAKE(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: GRN(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: GWETROOT(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: GWETTOP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: HFLUX(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: HKBETA(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: HKETA(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: LAI(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: LWI_GISS(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: LWI(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: MFXC(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: MFYC(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: MFZ(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: MOISTQ(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: MOLENGTH(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: OICE(:,:)      
      TYPE (XPLEX),  ALLOCATABLE :: OPTDEP(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: OPTD(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PARDF(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PARDR(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PBL(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PHIS(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PREACC(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PRECON(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PRECSNO(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PS1(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PS2(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PSC2(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: PV(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: QI(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: QL(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: RADLWG(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: RADSWG(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: RH(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SLP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SNICE(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SNODP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SNOMAS(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SNOW(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SPHU1(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SPHU2(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SPHU (:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: SUNCOS(:)
      TYPE (XPLEX),  ALLOCATABLE :: SUNCOSB(:)
      TYPE (XPLEX),  ALLOCATABLE :: T(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TAUCLI(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TAUCLW(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TO3(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TTO3(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TMPU1(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TMPU2(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TROPP1(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TROPP2(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TROPP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TS(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TSKIN(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: U10M(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: UPDE(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: UPDN(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: USTAR(:,:)  
      TYPE (XPLEX),  ALLOCATABLE :: UWND1(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: UWND2(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: UWND(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: V10M(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: VWND1(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: VWND2(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: VWND(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: Z0(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: ZMEU(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: ZMMD(:,:,:)
      TYPE (XPLEX),  ALLOCATABLE :: ZMMU(:,:,:)

      ! adj_group (dkh, 06/16/09) 
      TYPE (XPLEX),  ALLOCATABLE :: SLP_TMP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: LWI_TMP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TO3_TMP(:,:)
      TYPE (XPLEX),  ALLOCATABLE :: TTO3_TMP(:,:)
...
!  Arguments as Input:
!  ===========================================================================
!  (1 ) Z (TYPE (XPLEX)) : Quantity to be averaged over the pole (usually PS)
!                                               
!  NOTES:                            
...
#     include "CMN_SIZE"
      ...
      ! Arguments
      TYPE (XPLEX), INTENT(INOUT) :: Z(IIPAR,JJPAR)

      ! Local varaibles
      INTEGER               :: I, J

      TYPE (XPLEX)         :: TOTAL_Z1, TOTAL_Z2, TOTAL_Z3, TOTAL_Z4
      TYPE (XPLEX)          :: TOTAL_A1, TOTAL_A2, TOTAL_A3, TOTAL_A4
...
!  ========================================================================
!  (1 ) BXHEIGHT (TYPE (XPLEX) ) : Vertical extent of a grid box   [m       ]
!  (2 ) DELP     (TYPE (XPLEX) ) : Delta-P extent  of a grid box   [mb      ]
!  (3 ) AIRVOL   (TYPE (XPLEX) ) : Volume  of air  in a grid box   [m^3     ]
!  (4 ) AD       (TYPE (XPLEX) ) : Mass    of air  in a grid box   [kg      ]
!  (5 ) AIRDEN   (TYPE (XPLEX) ) : Density of air  in a grid box   [kg/m^3  ]
!
!  NOTES:
...
!        Eliminate TC variable, it's obsolete.  Now use TYPE (XPLEX) to
...
#     include "CMN_SIZE"    ! Size parameters
      ...
      ! Local variables
      INTEGER              :: I,        J,        L
      TYPE (XPLEX)               :: D_NTIME0, D_NTIME1, D_NDT
      TYPE (XPLEX)               :: D_NTDT,   TM,       TC2
      TYPE (XPLEX)               :: YSOUTH,   YNORTH
...
!  (3 ) THRESH   (TYPE (XPLEX) ) : LWI threshold for near-land 
...
#     include "CMN_SIZE"  ! Size parameters
      ...
      ! Conversion factor
      TYPE (XPLEX), PARAMETER   :: HCONV = xplex(28.97d-3 / 18.0d0,0d0) 
...
!  ===========================================================================
!  (1 ) SPHU (TYPE (XPLEX)) : Array containing 3-D specific humidity [g H2O/kg air]
!  (2 ) TMPU (TYPE (XPLEX)) : Array containing 3-D temperature field [K]
!  (3 ) RH   (TYPE (XPLEX)) : Output array for relative humidity     [%]
!
!  NOTES:
...
#     include "CMN_SIZE"  ! Size parameters
      ...
      ! Local variables
      TYPE (XPLEX), PARAMETER   :: A = xplex(23.5518d0,0d0)
      TYPE (XPLEX), PARAMETER   :: B = xplex(2937.4d0,0d0)
      TYPE (XPLEX), PARAMETER   :: C = xplex(-4.9283d0,0d0)
      TYPE (XPLEX)              :: ESAT, SHMB, PRES, TEMP
      INTEGER             :: I, J, L
...
#     include "CMN_GCTM"   ! Physical constants
      ...
      ! Parameters
      TYPE (XPLEX), PARAMETER :: KAPPA = xplex(0.4d0,0d0) 
      TYPE (XPLEX), PARAMETER :: CP    = xplex(1000.0d0,0d0)
...
!  Arguments as output:
!  ===========================================================================
!  (2 ) SUNCOS (TYPE (XPLEX) ) : 1D Array of cos(SZA) for each grid box (in radians)
!
!  NOTES:
!  (1 ) COSSZA is written in Fixed-Form Fortran 90.
!  (2 ) Use USE MYTYPE to declare all variables explicitly.                
!  (2 ) Use USE COMPLEXIFY to declare all variables explicitly.                
...
#     include "CMN_GCTM"    ! Physical constants
      ...
      TYPE (XPLEX),  INTENT(OUT) :: SUNCOS(MAXIJ)

      ! Local variables
      INTEGER              :: I, IJLOOP, J
      TYPE (XPLEX)               :: A0, A1, A2, A3, B1, B2, B3
      TYPE (XPLEX)               :: R, AHR, DEC, TIMLOC, YMID_R 
...
!  (2 ) NTRACE (INTEGER) : 
!  (3 ) TCVV   (TYPE (XPLEX) ) : Array containing [Air MW / Tracer MW] for tracers
!  (4 ) AD     (TYPE (XPLEX) ) : Array containing grid box air masses
!
!  Arguments as Input/Output:
!  ======================================================================
!  (5 ) STT    (TYPE (XPLEX) ) : Array containing tracer conc. [kg] or [v/v]
!
!  NOTES:
...
#     include "CMN_SIZE"     ! Size parameters
      ...
      TYPE (XPLEX),  INTENT(IN)    :: TCVV(N_TRACERS)
      TYPE (XPLEX),  INTENT(IN)    :: AD(IIPAR,JJPAR,LLPAR)
...
!$OMP+PRIVATE( I, J, L, N )
            ...
            DO J = 1, JJPAR
            DO I = 1, IIPAR
!               if (isnan(STT(I,J,L,N))) then
!      print*,'STT,AD,TCVV',STT(I,J,L,N),AD(I,J,L),TCVV(N),i,j,l,n
!               endif
               STT(I,J,L,N) = STT(I,J,L,N) * AD(I,J,L) / TCVV(N)
!               if (STT(I,J,L,N)%i/=0d0 .or. AD(I,J,L)%i/=0d0 .or.
!     & TCVV(N)%i/=0d0) then
!                  print*,'STT,AD,TCVV after',STT(I,J,L,N),AD(I,J,L),
!     & TCVV(N),i,j,l,n
!               endif
            ENDDO     
            ENDDO
...
#     include "CMN_SIZE"    ! Size parameters 
      ...
      ! Land/water flags have to be TYPE (XPLEX) for GCAP
